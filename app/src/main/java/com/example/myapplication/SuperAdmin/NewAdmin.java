...
public class NewAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout layoutDNI = findViewById(R.id.layDNI);
        ...
        // Establecer la opción preseleccionada en "Admin"
        selectTypeUser.setText("Administrador", false);
    ...
    private void uploadImageAndSaveUser(ListElementUser listElement, boolean isEditing) {
        if (imageUri != null) {
            try {
                ...
                String storagePath = "adminimages/" + listElement.getDni() + ".jpg";
                ...
                ref.putBytes(imageBytes)
                        ...
                        .addOnFailureListener(e -> {
                            Toast.makeText(NewAdmin.this, "Failed to upload image", Toast.LENGTH_SHORT).show();
                            e.printStackTrace();
                        });
            } catch (Exception e) {
                e.printStackTrace();
    ...
    private void createNewUser() {
        if (areFieldsEmpty() || !isImageAdded) {
            Toast.makeText(NewAdmin.this, "Debe completar todos los datos y seleccionar una imagen", Toast.LENGTH_SHORT).show();
        } else {
