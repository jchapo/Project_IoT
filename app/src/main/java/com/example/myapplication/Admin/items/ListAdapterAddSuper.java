...
public class ListAdapterAddSuper extends RecyclerView.Adapter<ListAdapterAddSuper.ViewHolder> {
    private List<ListElementUser> mData;
    private LayoutInflater mInflater;
    private List<ListElementUser> mSelectedItems = new ArrayList<>();

    public ListAdapterAddSuper(Context context, List<ListElementUser> data) {
